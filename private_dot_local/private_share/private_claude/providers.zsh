...
cct() {
  ...
  local ANTHROPIC_DEFAULT_FABLE_MODEL="claude-fable-5"
  local ANTHROPIC_DEFAULT_OPUS_MODEL="claude-opus-4-8"
  local ANTHROPIC_DEFAULT_SONNET_MODEL="claude-sonnet-4-6"
  local ANTHROPIC_DEFAULT_HAIKU_MODEL="claude-haiku-4-5"
  local ANTHROPIC_MODEL="opus"
  local CLAUDE_CODE_ENABLE_GATEWAY_MODEL_DISCOVERY="1"
  local CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC="1"
  local -a claude_env=(
    "ANTHROPIC_BASE_URL=$ANTHROPIC_BASE_URL"
