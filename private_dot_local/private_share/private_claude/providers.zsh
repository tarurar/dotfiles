...
cct() {
  ...
  local ANTHROPIC_DEFAULT_FABLE_MODEL_NAME="Fable via Tokenator"
  local ANTHROPIC_DEFAULT_OPUS_MODEL_NAME="Opus via Tokenator"
  local ANTHROPIC_DEFAULT_SONNET_MODEL_NAME="Sonnet via Tokenator"
  local ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME="Haiku via Tokenator"
  local ANTHROPIC_DEFAULT_FABLE_MODEL_DESCRIPTION="Claude Fable 5 through Tokenator"
  local ANTHROPIC_DEFAULT_OPUS_MODEL_DESCRIPTION="Claude Opus 4.8 through Tokenator"
  local ANTHROPIC_DEFAULT_SONNET_MODEL_DESCRIPTION="Claude Sonnet 4.6 through Tokenator"
  local ANTHROPIC_DEFAULT_HAIKU_MODEL_DESCRIPTION="Claude Haiku 4.5 through Tokenator"
  local ANTHROPIC_MODEL="sonnet"
